...
### About
Majority of the ACPI USB mapping out there utilizes `_UPC` to `XUPC` renames that is quite confusing and hard to follow. This method inspired by SSDTs such as [SSDT-RHUB](https://github.com/dortania/Getting-Started-With-ACPI/blob/master/extra-files/decompiled/SSDT-RHUB.dsl) and **SSDT-USB-Reset** generated by USBMap. 
