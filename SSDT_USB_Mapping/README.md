...
6. Take the `_ADR` of each ports from `RHUB`/`HUBN`
...
* This idea of `_STA`ing things was based on SSDT-USB-Reset generated by USBMap, and SSDT-RHUB. Information regarding `_UPC` method are from 5T33Z0 guide.
