...
### About
Majority of the ACPI USB mapping guide out there utilizes `_UPC` to `XUPC` renames that is quite confusing and hard to follow. This method is built above, and inspired with SSDTs such as [SSDT-RHUB](https://github.com/dortania/Getting-Started-With-ACPI/blob/master/extra-files/decompiled/SSDT-RHUB.dsl) and **SSDT-USB-Reset** generated by USBMap. 
